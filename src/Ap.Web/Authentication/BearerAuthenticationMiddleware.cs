...
namespace Ap.Web.Authentication
{
    ...
    //     public BearerAuthenticationMiddleware(IBearerTokenExtractorFactory tokenExtractorFactory
    //     , IAuthenticationTicketProviderFactory ticketProviderBuilder
    //     , RequestDelegate next, IOptions<BearerAuthenticationOptions> options
    //     , ILoggerFactory loggerFactory
    //     , UrlEncoder encoder) 
    //     : base(next, options, loggerFactory, encoder)
    //     {
    //         // AuthenticationScheme = options.Value.;
